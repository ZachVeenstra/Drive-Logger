...
//struct EditDriveView_Previews: PreviewProvider {
//    static var previews: some View {
//        EditDriveView(drive: <#T##FetchedResults<Drive>.Element#>)
//    }
//}
...
//                        VStack() {
//                            Text("Hours: \(Int(hours))")
//                            Slider(value: $hours, in: 0...50).accessibilityIdentifier("Seconds slider")
//                            Text("Minutes: \(Int(minutes))")
//                            Slider(value: $minutes, in: 0...59).accessibilityIdentifier("Minutes slider")
//                            Text("Seconds: \(Int(seconds))")
//                            Slider(value: $seconds, in: 0...59).accessibilityIdentifier("Hours slider")
//                        }
//                    }
//
//                    Section {
